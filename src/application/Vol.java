...
public abstract class Vol {
	...
	/**
	 * Mï¿½thode getVolsByHall.
	 * Cette mï¿½thode retourner hashMap des vols filtrï¿½ selon le nom du hall passï¿½ en paramï¿½tre
	 * @author ap
	 * @params String n : le nom du hall, en string
	 * @return : la map des vols filtrï¿½s
	...
	/**
	 * Mï¿½thode getVolsByHall.
	 * Cette mï¿½thode retourner hashMap des vols filtrï¿½ selon le hall passï¿½ en paramï¿½tre
	 * @author ap
