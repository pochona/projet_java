...
public class ecranHall3 extends JFrame{
	...
	public void init() {
		...
		Object[][] tableHall = new Object[Vol.getVolsByHall("3").keySet().size()][4];


		int index = 0;
		for (String keyH : Vol.getVolsByHall("3").keySet())
		{
			Vol vol = Vol.getVolsByHall("3").get(keyH);
